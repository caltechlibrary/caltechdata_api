...
def parse_readme_to_json(readme_path):
    ...
    for line_number, line in enumerate(lines, 1):
        ...
        if section_match:
            if item_list:
                ...
                if current_section in json_data:
                    ...
                    json_data[current_section] = [current_object] if current_section != "types" else current_object
                current_object = {}
        ...
        if key_value_match and current_section:
            ...
            elif key == "nameType" and current_object and current_section in ["creators", "contributors"]:
                contributors.append(current_object)
                current_object = {}
