...
VALID_DATACITE43_FILES = get_all_json_files(os.path.join(BASE_DIR, "data", "datacite43"))
...
@pytest.mark.parametrize(
    "missing_field_file",
    [
        {"file": os.path.join(DATACITE43_DIR, "missing_creators.json"), "missing_field": "creators"},
        {"file": os.path.join(DATACITE43_DIR, "missing_titles.json"), "missing_field": "titles"},
    ],
)
...
@pytest.mark.parametrize(
    "type_error_file",
    [
        {"file": os.path.join(DATACITE43_DIR, "type_error_creators.json"), "field": "creators"},
        {"file": os.path.join(DATACITE43_DIR, "type_error_dates.json"), "field": "dates"},
    ],
)
